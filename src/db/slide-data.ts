...
export const story: IObjectData = {
  1: {
    ...
    image: {
      uri: "https://baonamdinh.vn/file/e7837c02816d130b0181a995d7ad7e96/dataimages/202203/original/images1339861_Untitled_5.jpg"
    },
  },
  2: {
    id: 2,
    title: "Chúng em cùng bảo vệ môi trường",
    description:
      "Bao gồm việc ô nhiễm các nguồn nước như sông, ao hồ và nguồn nước ngầm bởi các chất gây ô nhiễm như chất hóa học, chất thải công nghiệp và nông nghiệp, và vi khuẩn từ nước thải.",
    content: [
      {
        ...
        image: {
          uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREX6QWyJAYX5w0JBc4TRWBbCzlyVYASwFF0w&s"
        },
      },
    ],
    image: {
      uri: "https://ktmt.vnmediacdn.com/stores/news_dataimages/ngoclt/112019/20/14/2145_bao_ve_moi_truong-2-minh_hoa.jpg"
    },
  },
};
...
export const activity: IObjectActivity = {
  1: {
    id: 1,
    title: "Làm ô tô bằng bìa cát tông ",
    image:
      "https://boxes.com.vn/wp-content/uploads/2024/04/Lam-oto-bang-thung-carton.jpg",
    target: "Học sinh",
    material: [
      "Bìa cát tông",
      "Kéo",
    ...
    instructions: [
      {
        title: "Bước 1: Chuẩn bị bìa",
        body: [
          "Lấy một chiếc hộp cát tông lớn",
          "Dùng băng keo để dán đáy hộp lại",
          "Sau đó dán miệng hộp để chừa lại một cánh nắp"
        ],
        image: "https://boxes.com.vn/wp-content/uploads/2024/04/Lam-oto-bang-thung-carton.jpg",
      },
      {
        title: "Bước 2: Tạo đầu xe",
        body: [
          "Dùng kéo để tạo 4 lỗ tròn trên thân xe vừa tạo để làm chỗ gắn bánh xe, lưu ý đo trước khi thực hiện để các lỗ đều nhau nhé.",
        ],
        image: "https://example.com/images/step2.jpg",
      },
      {
        title: "Bước 3: Làm bánh xe",
        body: [
          " Cắt 4 hình tròn để làm bánh xe, xuyên 2 que gỗ qua các dỗ vừa đục ở trên rồi cố định 4 hình tròn vào các đầu gỗ",
        ],
        image: "https://example.com/images/step3.jpg",
      },
      {
        title: "Bước 4: Trang trí xe",
        body: [
          "Trang trí xe hơi thú vị bằng cách sử dụng bút dạ, màu sáp, hoặc hình dán và giấy màu. Nếu bạn thích sự đơn giản, có thể không cần thực hiện bước này.",
        ],
        image: "https://example.com/images/step4.jpg",
      },
    ],
    benefit: [
      "Giáo dục về tái chế: Học sinh sẽ hiểu được tầm quan trọng của việc tái chế và giảm thiểu rác thải.",
      "Kỹ năng sống: Học sinh học được cách kiên nhẫn, tỉ mỉ.",
    ],
  },
  2: {
    id: 2,
